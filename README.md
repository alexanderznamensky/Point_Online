...
Кастомная интеграция для Home Assistant, которая позволяет получать данные из сервиса [Point_Online](https://point.online/) и использовать их в автоматизациях, сценариях и интерфейсе Home Assistant.
